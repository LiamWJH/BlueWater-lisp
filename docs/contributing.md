...
```git clone https://www.github.com/LiamWJH/Ordinta-lisp```

```cd "Ordinta-lisp"```

2. Choosing :D
Once you finished step 1 you will see several folders like _/docs_, _/Ordinta_ and files like _LICENSE_, and _readme_, if you wish you can contribute to any of these go to step 2.

3. IF YOU CHOSE TO EDIT THE **CODE**
If you chose to edit the code or the python code, go to via _/Ordinta_ folder then you can go to the _/src_ folder to edit the source code!
...
If you chose to edit the test cases for Ordinta , go to via _/Ordinta_ folder then you can go to the _/tests_ folder to add, edit, delete the test cases!
